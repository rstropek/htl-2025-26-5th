...
try
{
    ...
    var importer = host.Services.GetRequiredService<ITimesheetImporter>();

    // Perform the import
    var importedCount = await importer.ImportTimesheetsAsync(parsedArgs.FilePath, parsedArgs.IsDryRun);
...
static void ConfigureServices(IServiceCollection services, IConfiguration configuration)
{
    ...
    services.AddScoped<ITimesheetParser, TimesheetParser>();
    services.AddScoped<ITimesheetImportDatabaseReaderWriter, TimesheetImportDatabaseReaderWriter>();
    services.AddScoped<ITimesheetImporter, TimesheetImporter>();
}
